// Generated on 2016-09-29 using generator-angular-fullstack 4.0.5
'use strict';
...
gulp.task('generate-service-worker-dev', function(callback) {
    writeServiceWorkerFile(`${clientPath}`, false, callback);
});

gulp.task('generate-service-worker-dist', function(callback) {
    writeServiceWorkerFile(`${paths.dist}/${clientPath}`, true, callback);
});
